...
describe('Labels are correct', function () {
        ...
        it('TC-016 Instruction = "Let\'s create your own HERO! It\'s super easy with uor application', function () {
        ...
        it('TC-023 Type of story label = "4. What type of story would you like to read?"', function () {
            ...
            expect(label).toEqual(storyLabel);
        });
        it('TC-024 Image label = "5. Upload an image (optional)"', function () {
            let label = $$(sel.imageLabel)[4].getText();
            expect(label).toEqual(imageLabel);
        });
    });
        it('TC-025 Submit button label', function () {
        let submit = $(sel.submit).getText();
        expect(submit).toEqual(submitText);
    });
